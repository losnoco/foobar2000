...
int __PFASTCALL pexchangeadd(int* target, int value)
{
	int r = *target;
	*target += value;
	return r;
...
int __PFASTCALL pexchangeadd(int*, int)
{
	__asm
	{
#ifdef BCC_i386
...
int pexchangeadd(int* target, int value)
{
	__asm__ __volatile ("lock ; xaddl %0,(%1)" : "+r" (value) : "r" (target));
	return value;
}
