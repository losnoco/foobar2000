...
SHARED_EXPORT void uFixAmpersandChars(const char * src,string_base & out)
{
	out.reset();
	while(*src)
	{
...
SHARED_EXPORT void uFixAmpersandChars_v2(const char * src,string_base & out)
{
	out.reset();
	while(*src)
	{
...
extern "C"
{
	...
	SHARED_EXPORT BOOL uShellNotifyIcon(DWORD action,HWND wnd,UINT id,UINT callbackmsg,HICON icon,const char * tip)
	{
		NOTIFYICONDATA nid;
	...
	SHARED_EXPORT BOOL uShellNotifyIconEx(DWORD action,HWND wnd,UINT id,UINT callbackmsg,HICON icon,const char * tip,const char * balloon_title,const char * balloon_msg)
	{
