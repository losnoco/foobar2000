...
/************************* OpCode functions *************************/
void Interpreter::r4300i_J (void) {
...
void Interpreter::r4300i_JAL (void) {
	NextInstruction = DELAY_SLOT;
	JumpToLocation = (PROGRAM_COUNTER & 0xF0000000) + (Opcode.target << 2);
	TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,0,0);
...
void Interpreter::r4300i_BEQ (void) {
	NextInstruction = DELAY_SLOT;
...
void Interpreter::r4300i_BNE (void) {
	NextInstruction = DELAY_SLOT;
	if (GPR[Opcode.rs].DW != GPR[Opcode.rt].DW) {
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,Opcode.rt);
...
void Interpreter::r4300i_BLEZ (void) {
	NextInstruction = DELAY_SLOT;
...
void Interpreter::r4300i_BGTZ (void) {
	NextInstruction = DELAY_SLOT;
	if (GPR[Opcode.rs].DW > 0) {
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,0);
...
void Interpreter::r4300i_ADDI (void) {
	if (Opcode.rt == 0) { return; }
	GPR[Opcode.rt].DW = (GPR[Opcode.rs].W[0] + ((short)Opcode.immediate));
}

void Interpreter::r4300i_ADDIU (void) {
	GPR[Opcode.rt].DW = (GPR[Opcode.rs].W[0] + ((short)Opcode.immediate));
}

void Interpreter::r4300i_SLTI (void) {
	if (GPR[Opcode.rs].DW < (int64_t)((short)Opcode.immediate)) {
		GPR[Opcode.rt].DW = 1;
	} else {
		GPR[Opcode.rt].DW = 0;
	}
...
void Interpreter::r4300i_SLTIU (void) {
...
void Interpreter::r4300i_ANDI (void) {
	GPR[Opcode.rt].DW = GPR[Opcode.rs].DW & Opcode.immediate;
}

void Interpreter::r4300i_ORI (void) {
	GPR[Opcode.rt].DW = GPR[Opcode.rs].DW | Opcode.immediate;
}

void Interpreter::r4300i_XORI (void) {
	GPR[Opcode.rt].DW = GPR[Opcode.rs].DW ^ Opcode.immediate;
}

void Interpreter::r4300i_LUI (void) {
	if (Opcode.rt == 0) { return; }
	GPR[Opcode.rt].DW = (long)((short)Opcode.offset << 16);
}

void Interpreter::r4300i_BEQL (void) {
	if (GPR[Opcode.rs].DW == GPR[Opcode.rt].DW) {
		NextInstruction = DELAY_SLOT;
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,Opcode.rt);
...
void Interpreter::r4300i_BNEL (void) {
	if (GPR[Opcode.rs].DW != GPR[Opcode.rt].DW) {
		NextInstruction = DELAY_SLOT;
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,Opcode.rt);
...
void Interpreter::r4300i_BLEZL (void) {
	if (GPR[Opcode.rs].DW <= 0) {
		NextInstruction = DELAY_SLOT;
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,0);
...
void Interpreter::r4300i_BGTZL (void) {
	if (GPR[Opcode.rs].DW > 0) {
		NextInstruction = DELAY_SLOT;
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,0);
...
void Interpreter::r4300i_DADDIU (void) {
...
void Interpreter::r4300i_LDL (void) {
...
void Interpreter::r4300i_LDR (void) {
	uint32_t Offset, Address;
	uint64_t Value;
...
void Interpreter::r4300i_LB (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
	if (Opcode.rt == 0) { return; }
...
void Interpreter::r4300i_LH (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
...
void Interpreter::r4300i_LWL (void) {
...
void Interpreter::r4300i_LW (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
...
void Interpreter::r4300i_LBU (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
	if (!r4300i_LB_VAddr(Address,&GPR[Opcode.rt].UB[0])) {
		//if (ShowTLBMisses) {
...
void Interpreter::r4300i_LHU (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
	if ((Address & 1) != 0) { ADDRESS_ERROR_EXCEPTION(Address,1); }
	if (!r4300i_LH_VAddr(Address,&GPR[Opcode.rt].UHW[0])) {
		//if (ShowTLBMisses) {
...
void Interpreter::r4300i_LWR (void) {
	uint32_t Offset, Address, Value;
...
void Interpreter::r4300i_LWU (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
	if ((Address & 3) != 0) { ADDRESS_ERROR_EXCEPTION(Address,1); }
	if (Opcode.rt == 0) { return; }
...
void Interpreter::r4300i_SB (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
	if (!r4300i_SB_VAddr(Address,GPR[Opcode.rt].UB[0])) {
	}
}

void Interpreter::r4300i_SH (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
...
void Interpreter::r4300i_SWL (void) {
	uint32_t Offset, Address, Value;
...
void Interpreter::r4300i_SW (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
...
void Interpreter::r4300i_SDL (void) {
	uint32_t Offset, Address;
	uint64_t Value;
...
void Interpreter::r4300i_SDR (void) {
	uint32_t Offset, Address;
	uint64_t Value;
...
void Interpreter::r4300i_SWR (void) {
	uint32_t Offset, Address, Value;
...
void Interpreter::r4300i_CACHE (void) {
}

void Interpreter::r4300i_LL (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
	if ((Address & 3) != 0) { ADDRESS_ERROR_EXCEPTION(Address,1); }
	...
	LLBit = 1;
	LLAddr = Address;
	TranslateVaddr((uintptr_t *)&LLAddr);
}

void Interpreter::r4300i_LWC1 (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (uint32_t)((short)Opcode.offset);
...
void Interpreter::r4300i_SC (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
	if ((Address & 3) != 0) { ADDRESS_ERROR_EXCEPTION(Address,0); }
	if (LLBit == 1) {
		if (!r4300i_SW_VAddr(Address,GPR[Opcode.rt].UW[0])) {
...
void Interpreter::r4300i_LD (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
...
void Interpreter::r4300i_LDC1 (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
...
void Interpreter::r4300i_SWC1 (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
	TEST_COP1_USABLE_EXCEPTION
	if ((Address & 3) != 0) { ADDRESS_ERROR_EXCEPTION(Address,0); }
...
void Interpreter::r4300i_SDC1 (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
...
void Interpreter::r4300i_SD (void) {
	uint32_t Address =  GPR[Opcode.base].UW[0] + (short)Opcode.offset;
	if ((Address & 7) != 0) { ADDRESS_ERROR_EXCEPTION(Address,0); }
...
void Interpreter::r4300i_SPECIAL_SLL (void) {
	GPR[Opcode.rd].DW = (GPR[Opcode.rt].W[0] << Opcode.sa);
}

void Interpreter::r4300i_SPECIAL_SRL (void) {
	GPR[Opcode.rd].DW = (int)(GPR[Opcode.rt].UW[0] >> Opcode.sa);
}

void Interpreter::r4300i_SPECIAL_SRA (void) {
	GPR[Opcode.rd].DW = (GPR[Opcode.rt].W[0] >> Opcode.sa);
}

void Interpreter::r4300i_SPECIAL_SLLV (void) {
	if (Opcode.rd == 0) { return; }
	GPR[Opcode.rd].DW = (GPR[Opcode.rt].W[0] << (GPR[Opcode.rs].UW[0] & 0x1F));
}

void Interpreter::r4300i_SPECIAL_SRLV (void) {
	GPR[Opcode.rd].DW = (int)(GPR[Opcode.rt].UW[0] >> (GPR[Opcode.rs].UW[0] & 0x1F));
}

void Interpreter::r4300i_SPECIAL_SRAV (void) {
	GPR[Opcode.rd].DW = (GPR[Opcode.rt].W[0] >> (GPR[Opcode.rs].UW[0] & 0x1F));
}

void Interpreter::r4300i_SPECIAL_JR (void) {
	NextInstruction = DELAY_SLOT;
	JumpToLocation = GPR[Opcode.rs].UW[0];
}

void Interpreter::r4300i_SPECIAL_JALR (void) {
	NextInstruction = DELAY_SLOT;
	JumpToLocation = GPR[Opcode.rs].UW[0];
	GPR[Opcode.rd].DW = (long)(PROGRAM_COUNTER + 8);
}

void Interpreter::r4300i_SPECIAL_SYSCALL (void) {
	DoSysCallException(NextInstruction == JUMP);
	NextInstruction = JUMP;
	JumpToLocation = PROGRAM_COUNTER;
}

void Interpreter::r4300i_SPECIAL_BREAK (void) {
	*WaitMode=1;
}

void Interpreter::r4300i_SPECIAL_SYNC (void) {
}

void Interpreter::r4300i_SPECIAL_MFHI (void) {
	GPR[Opcode.rd].DW = HI.DW;
}

void Interpreter::r4300i_SPECIAL_MTHI (void) {
	HI.DW = GPR[Opcode.rs].DW;
}

void Interpreter::r4300i_SPECIAL_MFLO (void) {
	GPR[Opcode.rd].DW = LO.DW;
}

void Interpreter::r4300i_SPECIAL_MTLO (void) {
	LO.DW = GPR[Opcode.rs].DW;
}

void Interpreter::r4300i_SPECIAL_DSLLV (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rt].DW << (GPR[Opcode.rs].UW[0] & 0x3F);
}

void Interpreter::r4300i_SPECIAL_DSRLV (void) {
	GPR[Opcode.rd].UDW = GPR[Opcode.rt].UDW >> (GPR[Opcode.rs].UW[0] & 0x3F);
}

void Interpreter::r4300i_SPECIAL_DSRAV (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rt].DW >> (GPR[Opcode.rs].UW[0] & 0x3F);
}

void Interpreter::r4300i_SPECIAL_MULT (void) {
	HI.DW = (int64_t)(GPR[Opcode.rs].W[0]) * (int64_t)(GPR[Opcode.rt].W[0]);
	LO.DW = HI.W[0];
	HI.DW = HI.W[1];
}

void Interpreter::r4300i_SPECIAL_MULTU (void) {
	HI.DW = (uint64_t)(GPR[Opcode.rs].UW[0]) * (uint64_t)(GPR[Opcode.rt].UW[0]);
	LO.DW = HI.W[0];
	HI.DW = HI.W[1];
}

void Interpreter::r4300i_SPECIAL_DIV (void) {
...
void Interpreter::r4300i_SPECIAL_DIVU (void) {
	if ( GPR[Opcode.rt].UDW != 0 ) {
...
void Interpreter::r4300i_SPECIAL_DMULT (void) {
	MIPS_DWORD Tmp[3];
...
void Interpreter::r4300i_SPECIAL_DMULTU (void) {
	MIPS_DWORD Tmp[3];
...
void Interpreter::r4300i_SPECIAL_DDIV (void) {
	if ( GPR[Opcode.rt].UDW != 0 ) {
...
void Interpreter::r4300i_SPECIAL_DDIVU (void) {
	if ( GPR[Opcode.rt].UDW != 0 ) {
...
void Interpreter::r4300i_SPECIAL_ADD (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].W[0] + GPR[Opcode.rt].W[0];
}

void Interpreter::r4300i_SPECIAL_ADDU (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].W[0] + GPR[Opcode.rt].W[0];
}

void Interpreter::r4300i_SPECIAL_SUB (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].W[0] - GPR[Opcode.rt].W[0];
}

void Interpreter::r4300i_SPECIAL_SUBU (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].W[0] - GPR[Opcode.rt].W[0];
}

void Interpreter::r4300i_SPECIAL_AND (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].DW & GPR[Opcode.rt].DW;
}

void Interpreter::r4300i_SPECIAL_OR (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].DW | GPR[Opcode.rt].DW;
}

void Interpreter::r4300i_SPECIAL_XOR (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].DW ^ GPR[Opcode.rt].DW;
}

void Interpreter::r4300i_SPECIAL_NOR (void) {
	GPR[Opcode.rd].DW = ~(GPR[Opcode.rs].DW | GPR[Opcode.rt].DW);
}

void Interpreter::r4300i_SPECIAL_SLT (void) {
	if (GPR[Opcode.rs].DW < GPR[Opcode.rt].DW) {
		GPR[Opcode.rd].DW = 1;
	} else {
		GPR[Opcode.rd].DW = 0;
...
void Interpreter::r4300i_SPECIAL_SLTU (void) {
...
void Interpreter::r4300i_SPECIAL_DADD (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].DW + GPR[Opcode.rt].DW;
}

void Interpreter::r4300i_SPECIAL_DADDU (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].DW + GPR[Opcode.rt].DW;
}

void Interpreter::r4300i_SPECIAL_DSUB (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].DW - GPR[Opcode.rt].DW;
}

void Interpreter::r4300i_SPECIAL_DSUBU (void) {
	GPR[Opcode.rd].DW = GPR[Opcode.rs].DW - GPR[Opcode.rt].DW;
}

void Interpreter::r4300i_SPECIAL_TEQ (void) {
	if (GPR[Opcode.rs].DW == GPR[Opcode.rt].DW) {
	}
}

void Interpreter::r4300i_SPECIAL_DSLL (void) {
	GPR[Opcode.rd].DW = (GPR[Opcode.rt].DW << Opcode.sa);
}

void Interpreter::r4300i_SPECIAL_DSRL (void) {
	GPR[Opcode.rd].UDW = (GPR[Opcode.rt].UDW >> Opcode.sa);
}

void Interpreter::r4300i_SPECIAL_DSRA (void) {
	GPR[Opcode.rd].DW = (GPR[Opcode.rt].DW >> Opcode.sa);
}

void Interpreter::r4300i_SPECIAL_DSLL32 (void) {
	GPR[Opcode.rd].DW = (GPR[Opcode.rt].DW << (Opcode.sa + 32));
}

void Interpreter::r4300i_SPECIAL_DSRL32 (void) {
   GPR[Opcode.rd].UDW = (GPR[Opcode.rt].UDW >> (Opcode.sa + 32));
}

void Interpreter::r4300i_SPECIAL_DSRA32 (void) {
	GPR[Opcode.rd].DW = (GPR[Opcode.rt].DW >> (Opcode.sa + 32));
}

/********************** R4300i OpCodes: RegImm **********************/
void Interpreter::r4300i_REGIMM_BLTZ (void) {
	NextInstruction = DELAY_SLOT;
	if (GPR[Opcode.rs].DW < 0) {
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,0);
...
void Interpreter::r4300i_REGIMM_BGEZ (void) {
	NextInstruction = DELAY_SLOT;
	if (GPR[Opcode.rs].DW >= 0) {
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,0);
...
void Interpreter::r4300i_REGIMM_BLTZL (void) {
	if (GPR[Opcode.rs].DW < 0) {
		NextInstruction = DELAY_SLOT;
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,0);
...
void Interpreter::r4300i_REGIMM_BGEZL (void) {
	if (GPR[Opcode.rs].DW >= 0) {
		NextInstruction = DELAY_SLOT;
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,0);
...
void Interpreter::r4300i_REGIMM_BLTZAL (void) {
	NextInstruction = DELAY_SLOT;
	if (GPR[Opcode.rs].DW < 0) {
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,0);
...
void Interpreter::r4300i_REGIMM_BGEZAL (void) {
	NextInstruction = DELAY_SLOT;
	if (GPR[Opcode.rs].DW >= 0) {
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
		TestInterpreterJump(PROGRAM_COUNTER,JumpToLocation,Opcode.rs,0);
...
/************************** COP0 functions **************************/
void Interpreter::r4300i_COP0_MF (void) {
	GPR[Opcode.rt].DW = (int)CP0[Opcode.rd];
}

void Interpreter::r4300i_COP0_MT (void) {
	switch (Opcode.rd) {
	case 0: //Index
	case 2: //EntryLo0
	case 3: //EntryLo1
...
/************************** COP0 CO functions ***********************/
void Interpreter::r4300i_COP0_CO_TLBR (void) {
	TLB_Read();
}

void Interpreter::r4300i_COP0_CO_TLBWI (void) {
	WriteTLBEntry(INDEX_REGISTER & 0x1F);
}

void Interpreter::r4300i_COP0_CO_TLBWR (void) {
	WriteTLBEntry(RANDOM_REGISTER & 0x1F);
}

void Interpreter::r4300i_COP0_CO_TLBP (void) {
	TLB_Probe();
}

void Interpreter::r4300i_COP0_CO_ERET (void) {
	NextInstruction = JUMP;
...
/************************** COP1 functions **************************/
void Interpreter::r4300i_COP1_MF (void) {
	TEST_COP1_USABLE_EXCEPTION
	GPR[Opcode.rt].DW = *(int *)FPRFloatLocation[Opcode.fs];
}

void Interpreter::r4300i_COP1_DMF (void) {
	TEST_COP1_USABLE_EXCEPTION
	GPR[Opcode.rt].DW = *(int64_t *)FPRDoubleLocation[Opcode.fs];
}

void Interpreter::r4300i_COP1_CF (void) {
	TEST_COP1_USABLE_EXCEPTION
...
void Interpreter::r4300i_COP1_MT (void) {
	TEST_COP1_USABLE_EXCEPTION
	*(int *)FPRFloatLocation[Opcode.fs] = GPR[Opcode.rt].W[0];
}

void Interpreter::r4300i_COP1_DMT (void) {
	TEST_COP1_USABLE_EXCEPTION
	*(int64_t *)FPRDoubleLocation[Opcode.fs] = GPR[Opcode.rt].DW;
}

void Interpreter::r4300i_COP1_CT (void) {
	TEST_COP1_USABLE_EXCEPTION
	if (Opcode.fs == 31) {
...
/************************* COP1: BC1 functions ***********************/
void Interpreter::r4300i_COP1_BCF (void) {
	TEST_COP1_USABLE_EXCEPTION
	NextInstruction = DELAY_SLOT;
...
void Interpreter::r4300i_COP1_BCT (void) {
	TEST_COP1_USABLE_EXCEPTION
	NextInstruction = DELAY_SLOT;
	if ((FPCR[31] & FPCSR_C) != 0) {
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
...
void Interpreter::r4300i_COP1_BCFL (void) {
	TEST_COP1_USABLE_EXCEPTION
	if ((FPCR[31] & FPCSR_C) == 0) {
		NextInstruction = DELAY_SLOT;
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
...
void Interpreter::r4300i_COP1_BCTL (void) {
	TEST_COP1_USABLE_EXCEPTION
	if ((FPCR[31] & FPCSR_C) != 0) {
		NextInstruction = DELAY_SLOT;
		JumpToLocation = PROGRAM_COUNTER + ((short)Opcode.offset << 2) + 4;
...
void Interpreter::r4300i_COP1_S_ADD (void) {
	TEST_COP1_USABLE_EXCEPTION
...
void Interpreter::r4300i_COP1_S_SUB (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(float *)FPRFloatLocation[Opcode.fd] = (*(float *)FPRFloatLocation[Opcode.fs] - *(float *)FPRFloatLocation[Opcode.ft]);
}

void Interpreter::r4300i_COP1_S_MUL (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(float *)FPRFloatLocation[Opcode.fd] = (*(float *)FPRFloatLocation[Opcode.fs] * *(float *)FPRFloatLocation[Opcode.ft]);
}

void Interpreter::r4300i_COP1_S_DIV (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(float *)FPRFloatLocation[Opcode.fd] = (*(float *)FPRFloatLocation[Opcode.fs] / *(float *)FPRFloatLocation[Opcode.ft]);
}

void Interpreter::r4300i_COP1_S_SQRT (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(float *)FPRFloatLocation[Opcode.fd] = (float)sqrt(*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_ABS (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(float *)FPRFloatLocation[Opcode.fd] = (float)fabs(*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_MOV (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(float *)FPRFloatLocation[Opcode.fd] = *(float *)FPRFloatLocation[Opcode.fs];
}

void Interpreter::r4300i_COP1_S_NEG (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(float *)FPRFloatLocation[Opcode.fd] = (*(float *)FPRFloatLocation[Opcode.fs] * -1.0f);
}

void Interpreter::r4300i_COP1_S_TRUNC_L (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(_RC_CHOP,_MCW_RC);
	Float_RoundToInteger64(&*(int64_t *)FPRDoubleLocation[Opcode.fd],&*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_CEIL_L (void) {	//added by Witten
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(_RC_UP,_MCW_RC);
	Float_RoundToInteger64(&*(int64_t *)FPRDoubleLocation[Opcode.fd],&*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_FLOOR_L (void) {	//added by Witten
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(_RC_DOWN,_MCW_RC);
	Float_RoundToInteger64(&*(int64_t *)FPRDoubleLocation[Opcode.fd],&*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_ROUND_W (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(_RC_NEAR,_MCW_RC);
	Float_RoundToInteger32(&*(int *)FPRFloatLocation[Opcode.fd],&*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_TRUNC_W (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(_RC_CHOP,_MCW_RC);
	Float_RoundToInteger32(&*(int *)FPRFloatLocation[Opcode.fd],&*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_CEIL_W (void) {	//added by Witten
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(_RC_UP,_MCW_RC);
	Float_RoundToInteger32(&*(int *)FPRFloatLocation[Opcode.fd],&*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_FLOOR_W (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(_RC_DOWN,_MCW_RC);
	Float_RoundToInteger32(&*(int *)FPRFloatLocation[Opcode.fd],&*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_CVT_D (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(double *)FPRDoubleLocation[Opcode.fd] = (double)(*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_CVT_W (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	Float_RoundToInteger32(&*(int *)FPRFloatLocation[Opcode.fd],&*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_CVT_L (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	Float_RoundToInteger64(&*(int64_t *)FPRDoubleLocation[Opcode.fd],&*(float *)FPRFloatLocation[Opcode.fs]);
}

void Interpreter::r4300i_COP1_S_CMP (void) {
...
/************************** COP1: W functions ************************/
void Interpreter::r4300i_COP1_W_CVT_S (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(float *)FPRFloatLocation[Opcode.fd] = (float)*(int *)FPRFloatLocation[Opcode.fs];
}

void Interpreter::r4300i_COP1_W_CVT_D (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
...
/************************** COP1: L functions ************************/
void Interpreter::r4300i_COP1_L_CVT_S (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
	*(float *)FPRFloatLocation[Opcode.fd] = (float)*(int64_t *)FPRDoubleLocation[Opcode.fs];
}

void Interpreter::r4300i_COP1_L_CVT_D (void) {
	TEST_COP1_USABLE_EXCEPTION
	//_controlfp(RoundingModel,_MCW_RC);
...
/************************** Other functions **************************/
void Interpreter::R4300i_UnknownOpcode (void) {
	char Message[200];
