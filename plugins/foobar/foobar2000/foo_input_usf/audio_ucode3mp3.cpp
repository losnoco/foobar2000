...
void Abi3::MP3 () {
	...
	readPtr  = writePtr;
	memcpy (mp3data+0xCE8, hCpu.N64MEM+(readPtr), 8); // Just do that for efficiency... may remove and use directly later anyway
	readPtr += 8; // This must be a header byte or whatnot

	for (int cnt = 0; cnt < 0x480; cnt += 0x180) {
		memcpy (mp3data+0xCF0, hCpu.N64MEM+(readPtr), 0x180); // DMA: 0xCF0 <- hCpu.N64MEM[s5] : 0x180
		inPtr  = 0xCF0; // s7
		outPtr = 0xE70; // s3
// --------------- Inner Loop Start --------------------
...
// --------------- Inner Loop End --------------------
		memcpy ((uint8_t*)hCpu.N64MEM+writePtr, mp3data+0xe70, 0x180);
		writePtr += 0x180;
		readPtr  += 0x180;
	}
}
...
void Abi3::InnerLoop () {
				...
				int i;
				v[0] = *(int16_t *)(mp3data+inPtr+(0x00^2)); v[31] = *(int16_t *)(mp3data+inPtr+(0x3E^2)); v[0] += v[31];
				v[1] = *(int16_t *)(mp3data+inPtr+(0x02^2)); v[30] = *(int16_t *)(mp3data+inPtr+(0x3C^2)); v[1] += v[30];
				v[2] = *(int16_t *)(mp3data+inPtr+(0x06^2)); v[28] = *(int16_t *)(mp3data+inPtr+(0x38^2)); v[2] += v[28];
				v[3] = *(int16_t *)(mp3data+inPtr+(0x04^2)); v[29] = *(int16_t *)(mp3data+inPtr+(0x3A^2)); v[3] += v[29];

				v[4] = *(int16_t *)(mp3data+inPtr+(0x0E^2)); v[24] = *(int16_t *)(mp3data+inPtr+(0x30^2)); v[4] += v[24];
				v[5] = *(int16_t *)(mp3data+inPtr+(0x0C^2)); v[25] = *(int16_t *)(mp3data+inPtr+(0x32^2)); v[5] += v[25];
				v[6] = *(int16_t *)(mp3data+inPtr+(0x08^2)); v[27] = *(int16_t *)(mp3data+inPtr+(0x36^2)); v[6] += v[27];
				v[7] = *(int16_t *)(mp3data+inPtr+(0x0A^2)); v[26] = *(int16_t *)(mp3data+inPtr+(0x34^2)); v[7] += v[26];

				v[8] = *(int16_t *)(mp3data+inPtr+(0x1E^2)); v[16] = *(int16_t *)(mp3data+inPtr+(0x20^2)); v[8] += v[16];
				v[9] = *(int16_t *)(mp3data+inPtr+(0x1C^2)); v[17] = *(int16_t *)(mp3data+inPtr+(0x22^2)); v[9] += v[17];
				v[10]= *(int16_t *)(mp3data+inPtr+(0x18^2)); v[19] = *(int16_t *)(mp3data+inPtr+(0x26^2)); v[10]+= v[19];
				v[11]= *(int16_t *)(mp3data+inPtr+(0x1A^2)); v[18] = *(int16_t *)(mp3data+inPtr+(0x24^2)); v[11]+= v[18];

				v[12]= *(int16_t *)(mp3data+inPtr+(0x10^2)); v[23] = *(int16_t *)(mp3data+inPtr+(0x2E^2)); v[12]+= v[23];
				v[13]= *(int16_t *)(mp3data+inPtr+(0x12^2)); v[22] = *(int16_t *)(mp3data+inPtr+(0x2C^2)); v[13]+= v[22];
				v[14]= *(int16_t *)(mp3data+inPtr+(0x16^2)); v[20] = *(int16_t *)(mp3data+inPtr+(0x28^2)); v[14]+= v[20];
				v[15]= *(int16_t *)(mp3data+inPtr+(0x14^2)); v[21] = *(int16_t *)(mp3data+inPtr+(0x2A^2)); v[15]+= v[21];
...
//					__asm int 3;
				...
				*(int16_t *)(mp3data+((t0+(short)0xFFA0))) = (short)v[2];
				...
				//u64 *DW = (uint64_t *)&DeWindowLUT[0x10-(t4>>1)];
