...
void Cpu::DoAddressError ( uint32_t DelaySlot, uint32_t BadVaddr, uint32_t FromRead) {
	if (FromRead) {
...
void Cpu::DoBreakException ( uint32_t DelaySlot) {
...
void Cpu::DoCopUnusableException ( uint32_t DelaySlot, uint32_t Coprocessor ) {
...
void Cpu::DoIntrException ( uint32_t DelaySlot ) {
...
void Cpu::DoTLBMiss ( uint32_t DelaySlot, uint32_t BadVaddr ) {
...
void Cpu::DoSysCallException ( uint32_t DelaySlot) {
