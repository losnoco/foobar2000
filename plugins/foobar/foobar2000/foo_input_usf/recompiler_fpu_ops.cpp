...
void Recompiler::ChangeDefaultRoundingModel (void) {
	/*switch((FPCR[31] & 3)) {
...
void Recompiler::CompileCop1Test (BLOCK_SECTION * Section) {
	if (FpuBeenUsed) { return; }
	TestVariable(STATUS_CU1,&STATUS_REGISTER);
	//CompileExit(Section->CompilePC,&Section->RegWorking,COP1_Unuseable,0,(void (*)(uint32_t))-1);
	CompileExit(Section->CompilePC,&Section->RegWorking,COP1_Unuseable,0,&Recompiler::JeLabel32);
	FpuBeenUsed = 1;
}

/********************** Load/store functions ************************/
void Recompiler::Compile_R4300i_LWC1 (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_LDC1 (BLOCK_SECTION * Section) {
	uint32_t TempReg1, TempReg2, TempReg3;
...
void Recompiler::Compile_R4300i_SWC1 (BLOCK_SECTION * Section){
	uint32_t TempReg1, TempReg2, TempReg3;
...
void Recompiler::Compile_R4300i_SDC1 (BLOCK_SECTION * Section){
	uint32_t TempReg1, TempReg2, TempReg3;
...
/************************** COP1 functions **************************/
void Recompiler::Compile_R4300i_COP1_MF (BLOCK_SECTION * Section) {
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_DMF (BLOCK_SECTION * Section) {
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_CF(BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_MT( BLOCK_SECTION * Section) {
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_DMT( BLOCK_SECTION * Section) {
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_CT(BLOCK_SECTION * Section) {
...
/************************** COP1: S functions ************************/
void Recompiler::Compile_R4300i_COP1_S_ADD (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_SUB (BLOCK_SECTION * Section) {
	uint32_t Reg1 = Opcode.ft == Opcode.fd?Opcode.ft:Opcode.fs;
	uint32_t Reg2 = Opcode.ft == Opcode.fd?Opcode.fs:Opcode.ft;
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_S_MUL (BLOCK_SECTION * Section) {
	uint32_t Reg1 = Opcode.ft == Opcode.fd?Opcode.ft:Opcode.fs;
	uint32_t Reg2 = Opcode.ft == Opcode.fd?Opcode.fs:Opcode.ft;
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_S_DIV (BLOCK_SECTION * Section) {
	uint32_t Reg1 = Opcode.ft == Opcode.fd?Opcode.ft:Opcode.fs;
	uint32_t Reg2 = Opcode.ft == Opcode.fd?Opcode.fs:Opcode.ft;
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_S_ABS (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_NEG (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_SQRT (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_MOV (BLOCK_SECTION * Section) {

	Load_FPR_ToTop(Section,Opcode.fd,Opcode.fs,FPU_Float);
}

void Recompiler::Compile_R4300i_COP1_S_TRUNC_L (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_CEIL_L (BLOCK_SECTION * Section) {			//added by Witten
...
void Recompiler::Compile_R4300i_COP1_S_FLOOR_L (BLOCK_SECTION * Section) {			//added by Witten
...
void Recompiler::Compile_R4300i_COP1_S_ROUND_W (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_TRUNC_W (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_CEIL_W (BLOCK_SECTION * Section) {			// added by Witten
...
void Recompiler::Compile_R4300i_COP1_S_FLOOR_W (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_CVT_D (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_CVT_W (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_CVT_L (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_S_CMP (BLOCK_SECTION * Section) {
...
/************************** COP1: D functions ************************/
void Recompiler::Compile_R4300i_COP1_D_ADD (BLOCK_SECTION * Section) {
	uint32_t Reg1 = Opcode.ft == Opcode.fd?Opcode.ft:Opcode.fs;
	uint32_t Reg2 = Opcode.ft == Opcode.fd?Opcode.fs:Opcode.ft;
...
void Recompiler::Compile_R4300i_COP1_D_SUB (BLOCK_SECTION * Section) {
	uint32_t Reg1 = Opcode.ft == Opcode.fd?Opcode.ft:Opcode.fs;
	uint32_t Reg2 = Opcode.ft == Opcode.fd?Opcode.fs:Opcode.ft;
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_D_MUL (BLOCK_SECTION * Section) {
	uint32_t Reg1 = Opcode.ft == Opcode.fd?Opcode.ft:Opcode.fs;
	uint32_t Reg2 = Opcode.ft == Opcode.fd?Opcode.fs:Opcode.ft;
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_D_DIV (BLOCK_SECTION * Section) {
	uint32_t Reg1 = Opcode.ft == Opcode.fd?Opcode.ft:Opcode.fs;
	uint32_t Reg2 = Opcode.ft == Opcode.fd?Opcode.fs:Opcode.ft;
	uint32_t TempReg;
...
void Recompiler::Compile_R4300i_COP1_D_ABS (BLOCK_SECTION * Section) {

	Load_FPR_ToTop(Section,Opcode.fd,Opcode.fs,FPU_Double);
	fpuAbs();
}

void Recompiler::Compile_R4300i_COP1_D_NEG (BLOCK_SECTION * Section) {

	Load_FPR_ToTop(Section,Opcode.fd,Opcode.fs,FPU_Double);
	fpuNeg();
}

void Recompiler::Compile_R4300i_COP1_D_SQRT (BLOCK_SECTION * Section) {

	Load_FPR_ToTop(Section,Opcode.fd,Opcode.fs,FPU_Double);
	fpuSqrt();
}

void Recompiler::Compile_R4300i_COP1_D_MOV (BLOCK_SECTION * Section) {

	Load_FPR_ToTop(Section,Opcode.fd,Opcode.fs,FPU_Double);
}

void Recompiler::Compile_R4300i_COP1_D_TRUNC_L (BLOCK_SECTION * Section) {			//added by Witten
...
void Recompiler::Compile_R4300i_COP1_D_CEIL_L (BLOCK_SECTION * Section) {			//added by Witten
...
void Recompiler::Compile_R4300i_COP1_D_FLOOR_L (BLOCK_SECTION * Section) {			//added by Witten
...
void Recompiler::Compile_R4300i_COP1_D_ROUND_W (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_D_TRUNC_W (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_D_CEIL_W (BLOCK_SECTION * Section) {				// added by Witten
...
void Recompiler::Compile_R4300i_COP1_D_FLOOR_W (BLOCK_SECTION * Section) {			//added by Witten
...
void Recompiler::Compile_R4300i_COP1_D_CVT_S (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_D_CVT_W (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_D_CVT_L (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_D_CMP (BLOCK_SECTION * Section) {
	uint32_t Reg1 = RegInStack(Section,Opcode.ft, FPU_Float)?Opcode.ft:Opcode.fs;
	uint32_t Reg2 = RegInStack(Section,Opcode.ft, FPU_Float)?Opcode.fs:Opcode.ft;
	int x86reg, cmp = 0;
...
/************************** COP1: W functions ************************/
void Recompiler::Compile_R4300i_COP1_W_CVT_S (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_W_CVT_D (BLOCK_SECTION * Section) {
...
/************************** COP1: L functions ************************/
void Recompiler::Compile_R4300i_COP1_L_CVT_S (BLOCK_SECTION * Section) {
...
void Recompiler::Compile_R4300i_COP1_L_CVT_D (BLOCK_SECTION * Section) {
