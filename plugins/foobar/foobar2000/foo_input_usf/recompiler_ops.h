...
void Compile_R4300i_Branch (BLOCK_SECTION * Section, void (Recompiler::*CompareFunc)(BLOCK_SECTION * Section), int32_t BranchType, uint32_t Link);
void Compile_R4300i_BranchLikely   ( BLOCK_SECTION * Section, void (Recompiler::*CompareFunc)(BLOCK_SECTION * Section), uint32_t Link);
