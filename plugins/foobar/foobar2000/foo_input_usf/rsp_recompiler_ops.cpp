 ...
 *
 * Project64 is freefware for PERSONAL USE only. Commercial users should
...
void Rsp::RSPBranch_AddRef(uint32_t Target, uint32_t * X86Loc) {
...
void Rsp::RSPCheat_r4300iOpcode ( void (RSPCALL  Rsp:: *FunctAddress)()) {
	...
	RSPCall_Direct(GetAddress(0, FunctAddress));
	RSPAddConstToX86Reg(x86_ESP, 4);
	RSPPopad();
}

void Rsp::RSPCheat_r4300iOpcodeNoMessage( void (RSPCALL Rsp:: *FunctAddress)()) {
	RSPPushad();
	RSPMoveConstToVariable(RSPOpC.Hex, &RSPOpC.Hex );
	RSPPushImm32((uint32_t)this);
	RSPCall_Direct(GetAddress(0, FunctAddress));
...
void RSPX86::RSPx86_SetBranch8b(void * JumpByte, void * Destination) {
...
void RSPX86::RSPx86_SetBranch32b(void * JumpByte, void * Destination) {
...
/************************* OpCode functions *************************/
void Rsp::RSPCompile_SPECIAL ( void ) {
	(this->*RSP_Special[ RSPOpC.funct ])();
}

void Rsp::RSPCompile_REGIMM ( void ) {
	(this->*RSP_RegImm[ RSPOpC.rt ])();
}

void Rsp::RSPCompile_J ( void ) {
...
void Rsp::RSPCompile_ADDI ( void ) {
	int32_t Immediate = (int16_t)RSPOpC.immediate;

	#ifndef RSPCompile_Immediates
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_ADDI); return;
	#endif
...
void Rsp::RSPCompile_ADDIU ( void ) {
	int32_t Immediate = (int16_t)RSPOpC.immediate;

	#ifndef RSPCompile_Immediates
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_ADDIU); return;
	#endif
...
void Rsp::RSPCompile_SLTI ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SLTI);
}

void Rsp::RSPCompile_SLTIU ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SLTIU);
}

void Rsp::RSPCompile_ANDI ( void ) {
	int32_t Immediate = (uint16_t)RSPOpC.immediate;

	#ifndef RSPCompile_Immediates
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_ANDI); return;
	#endif
...
void Rsp::RSPCompile_ORI ( void ) {
	int32_t Immediate = (uint16_t)RSPOpC.immediate;

	#ifndef RSPCompile_Immediates
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_ORI); return;
	#endif
...
void Rsp::RSPCompile_XORI ( void ) {
	int32_t Immediate = (uint16_t)RSPOpC.immediate;

	#ifndef RSPCompile_Immediates
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_XORI); return;
	#endif
...
void Rsp::RSPCompile_LUI ( void ) {
	int32_t n = (int16_t)RSPOpC.offset << 16;

	#ifndef RSPCompile_Immediates
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LUI); return;
	#endif
...
void Rsp::RSPCompile_COP0 (void) {
	(this->*RSP_Cop0[ RSPOpC.rs ])();
}

void Rsp::RSPCompile_COP2 (void) {
	(this->*RSP_Cop2[ RSPOpC.rs ])();
}

void Rsp::RSPCompile_LB ( void ) {
	int32_t Offset = (int16_t)RSPOpC.offset;

	#ifndef RSPCompile_GPRLoads
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LB); return;
	#endif
...
void Rsp::RSPCompile_LH ( void ) {
	int32_t Offset = (int16_t)RSPOpC.offset;
	uint8_t * Jump[2];

	#ifndef RSPCompile_GPRLoads
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LH); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 1) != 0) {
			...
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_LH);
			return;
		} else {


			RSPMoveSxVariableToX86regHalf(cpu.DMEM + Addr, x86_EAX);
			RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
			return;
		}
	}
...
void Rsp::RSPCompile_LW ( void ) {
	int32_t Offset = (int16_t)RSPOpC.offset;
	uint8_t * Jump[2];

	#ifndef RSPCompile_GPRLoads
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LW); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 3) != 0) {
			CompilerWarning( RSPCompilePC);
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_LW);
			return;
		} else {


			RSPMoveVariableToX86reg(cpu.DMEM + Addr, x86_EAX);
			RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
			return;
		}
	}
...
void Rsp::RSPCompile_LBU ( void ) {
	int32_t Offset = (int16_t)RSPOpC.offset;

	#ifndef RSPCompile_GPRLoads
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LBU); return;
	#endif
...
void Rsp::RSPCompile_LHU ( void ) {
	int32_t Offset = (int16_t)RSPOpC.offset;
	uint8_t * Jump[2];

	#ifndef RSPCompile_GPRLoads
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LHU); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 1) != 0) {
			CompilerWarning( RSPCompilePC);
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_LHU);
			return;
		} else {


			RSPMoveZxVariableToX86regHalf(cpu.DMEM + Addr, x86_ECX);
...
void Rsp::RSPCompile_SB ( void ) {
	int32_t Offset = (int16_t)RSPOpC.offset;

	#ifndef RSPCompile_GPRStores
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SB); return;
	#endif
...
void Rsp::RSPCompile_SH ( void ) {
	int32_t Offset = (int16_t)RSPOpC.offset;
	uint8_t * Jump[2];

	#ifndef RSPCompile_GPRStores
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SH); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Offset & 1) != 0) {
			CompilerWarning( RSPCompilePC);
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_SH);
			return;
		} else {


			RSPMoveVariableToX86regHalf(&RSP_GPR[RSPOpC.rt].UW, x86_EAX);
			RSPMoveX86regHalfToVariable(x86_EAX, cpu.DMEM + Addr);
			return;
		}
	}
...
void Rsp::RSPCompile_SW ( void ) {
	int32_t Offset = (int16_t)RSPOpC.offset;
	uint8_t * Jump[2];

	#ifndef RSPCompile_GPRStores
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SW); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 3) != 0) {
			CompilerWarning( RSPCompilePC);
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_SW);
			return;
		} else {


			RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].UW, x86_EAX);
			RSPMoveX86regToVariable(x86_EAX, cpu.DMEM + Addr);
			return;
		}
	}
...
void Rsp::RSPCompile_LC2 (void) {
	(this->*RSP_Lc2 [ RSPOpC.rd ])();
}

void Rsp::RSPCompile_SC2 (void) {
	(this->*RSP_Sc2 [ RSPOpC.rd ])();
}
/********************** R4300i OpCodes: Special **********************/

void Rsp::RSPCompile_Special_SLL ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SLL); return;
	#endif
...
void Rsp::RSPCompile_Special_SRL ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SRL); return;
	#endif
...
void Rsp::RSPCompile_Special_SRA ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SRA); return;
	#endif
...
void Rsp::RSPCompile_Special_SLLV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SLLV);
}

void Rsp::RSPCompile_Special_SRLV ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SRLV); return;
	#endif
...
void Rsp::RSPCompile_Special_SRAV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SRAV);
}

void Rsp::RSPCompile_Special_JR (void) {
	uint8_t * Jump;
...
void Rsp::RSPCompile_Special_JALR ( void ) {
	uint8_t * Jump;
...
void Rsp::RSPCompile_Special_BREAK ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_BREAK);
	if (RSPNextInstruction != NORMAL) {
...
void Rsp::RSPCompile_Special_ADD ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_ADD); return;
	#endif
...
void Rsp::RSPCompile_Special_ADDU ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_ADDU); return;
	#endif
...
void Rsp::RSPCompile_Special_SUB ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SUB); return;
	#endif
...
void Rsp::RSPCompile_Special_SUBU ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SUBU); return;
	#endif
...
void Rsp::RSPCompile_Special_AND ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_AND); return;
	#endif
...
void Rsp::RSPCompile_Special_OR ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_OR); return;
	#endif
...
void Rsp::RSPCompile_Special_XOR ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_XOR); return;
	#endif
...
void Rsp::RSPCompile_Special_NOR ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_NOR);
}

void Rsp::RSPCompile_Special_SLT ( void ) {
	#ifndef RSPCompile_Special
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SLT); return;
	#endif
...
void Rsp::RSPCompile_Special_SLTU ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Special_SLTU);
}

/********************** R4300i OpCodes: RegImm **********************/
void Rsp::RSPCompile_RegImm_BLTZ ( void ) {
...
void Rsp::RSPCompile_RegImm_BGEZ ( void ) {
...
void Rsp::RSPCompile_RegImm_BLTZAL ( void ) {
	if ( RSPNextInstruction == NORMAL ) {
		CPU_Message(RSPCompilePC,RSPOpcodeName(RSPOpC.Hex,RSPCompilePC));
		RSPMoveConstToVariable(RSPCompilePC + 8, &RSP_GPR[31].UW);
		if (RSPOpC.rs == 0) {
...
void Rsp::RSPCompile_RegImm_BGEZAL ( void ) {
...
void Rsp::RSPCompile_Cop0_MF ( void ) {
	#ifndef RSPCompile_Cop0
	RSPCheat_r4300iOpcode(&Rsp::RSP_Cop0_MF); return;
	#endif
	...
	switch (RSPOpC.rd) {
	case 4:
		RSPMoveVariableToX86reg(&cpu.SP_STATUS_REG, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
		break;
	case 5:
		RSPMoveVariableToX86reg(&cpu.SP_DMA_FULL_REG, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
		break;
	case 6:
		RSPMoveVariableToX86reg(&cpu.SP_DMA_BUSY_REG, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
		break;
	case 7:
		RSPMoveConstToVariable(0, &RSP_GPR[RSPOpC.rt].UW);
		//RSPCheat_r4300iOpcode(&Rsp::RSP_Cop0_MF);
		break;
	case 8:
		RSPMoveVariableToX86reg(&cpu.DPC_START_REG, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
		break;
	case 9:
		RSPMoveVariableToX86reg(&cpu.DPC_END_REG, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
		break;
	case 10:
		RSPMoveVariableToX86reg(&cpu.DPC_CURRENT_REG, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
		break;
	case 11:
		RSPMoveVariableToX86reg(&cpu.DPC_STATUS_REG, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
		break;
	case 12:
		RSPMoveVariableToX86reg(&cpu.DPC_CLOCK_REG, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &RSP_GPR[RSPOpC.rt].UW);
		break;
...
void Rsp::RSPCompile_Cop0_MT ( void ) {
#ifndef RSPCompile_Cop0
	RSPCheat_r4300iOpcode(&Rsp::RSP_Cop0_MT);
#else
	CPU_Message(RSPCompilePC,RSPOpcodeName(RSPOpC.Hex,RSPCompilePC));
	...
	case 0:
		RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].UW, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &cpu.SP_MEM_ADDR_REG);
		break;
	case 1:
		RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].UW, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &cpu.SP_DRAM_ADDR_REG);
		break;
	case 2:
		RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].UW, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &cpu.SP_RD_LEN_REG);
		RSPPushad();
		CALL_RSPFUNC(&Rsp::RSP_SP_DMA_READ);
		RSPPopad();
		break;
	case 3:
		RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].UW, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &cpu.SP_WR_LEN_REG);
		RSPPushad();
		CALL_RSPFUNC(&Rsp::RSP_SP_DMA_WRITE);
		RSPPopad();
		break;
	case 7:
		RSPMoveConstToVariable(0, &cpu.SP_SEMAPHORE_REG);
		break;
	case 8:
		RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].UW, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &cpu.DPC_START_REG);
		RSPMoveX86regToVariable(x86_EAX, &cpu.DPC_CURRENT_REG);
		break;
	case 9:
		RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].UW, x86_EAX);
		RSPMoveX86regToVariable(x86_EAX, &cpu.DPC_END_REG);
	...
	if (RSPOpC.rd == 2) {
		...
		RSPTestConstToVariable(0x1000, &cpu.SP_MEM_ADDR_REG);
		RSPJeLabel8( 0);
		Jump = RSPRecompPos - 1;
...
void Rsp::RSPCompile_Cop2_MF ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Cop2_MF); return;
	#endif
...
void Rsp::RSPCompile_Cop2_CF ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Cop2_CF);
}

void Rsp::RSPCompile_Cop2_MT ( void ) {

	int32_t element = 15 - (RSPOpC.sa >> 1);

	#ifndef RSPCompile_Cop2
	RSPCheat_r4300iOpcode(&Rsp::RSP_Cop2_MT); return;
	#endif
...
void Rsp::RSPCompile_Cop2_CT ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Cop2_CT);
}

void Rsp::RSPCompile_COP2_VECTOR (void) {
	(this->*RSP_Vector[ RSPOpC.funct ])();
}

/************************** Vect functions **************************/


void Rsp::RSP_Element2Mmx(int32_t MmxReg) {
...
void Rsp::RSP_MultiElement2Mmx(int32_t MmxReg1, int32_t MmxReg2) {
...
int32_t Rsp::RSPCompile_Vector_VMULF_MMX ( void ) {
...
void Rsp::RSPCompile_Vector_VMULF ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMULF); return;
	#endif
...
void Rsp::RSPCompile_Vector_VMULU ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMULU);
}

int32_t Rsp::RSPCompile_Vector_VMUDL_MMX ( void ) {
...
void Rsp::RSPCompile_Vector_VMUDL ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMUDL); return;
	#endif
...
int32_t Rsp::RSPCompile_Vector_VMUDM_MMX ( void ) {
...
void Rsp::RSPCompile_Vector_VMUDM ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMUDM); return;
	#endif
...
int32_t Rsp::RSPCompile_Vector_VMUDN_MMX ( void ) {
...
void Rsp::RSPCompile_Vector_VMUDN ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMUDN); return;
	#endif
...
int32_t Rsp::RSPCompile_Vector_VMUDH_MMX ( void ) {
...
void Rsp::RSPCompile_Vector_VMUDH ( void ) {
...
//	RSPBreakPoint();
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMUDH); return;
	#endif
...
void Rsp::RSPCompile_Vector_VMACF ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMACF); return;
	#endif
...
void Rsp::RSPCompile_Vector_VMACU ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMACU);
}

void Rsp::RSPCompile_Vector_VMACQ ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMACQ);
}

void Rsp::RSPCompile_Vector_VMADL ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMADL); return;
	#endif
...
void Rsp::RSPCompile_Vector_VMADM ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMADM); return;
	#endif
...
void Rsp::RSPCompile_Vector_VMADN ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMADN); return;
	#endif
...
void Rsp::RSPCompile_Vector_VMADH ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMADH); return;
	#endif
...
int32_t Rsp::RSPCompile_Vector_VADD_MMX ( void ) {
...
void Rsp::RSPCompile_Vector_VADD ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VADD); return;
	#endif
...
void Rsp::RSPCompile_Vector_VSUB ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VSUB); return;
	#endif
...
void Rsp::RSPCompile_Vector_VABS ( void ) {
	int32_t count, el, del;
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VABS); return;
	#endif
...
void Rsp::RSPCompile_Vector_VADDC ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VADDC); return;
	#endif
...
void Rsp::RSPCompile_Vector_VSUBC ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VSUBC); return;
	#endif
...
void Rsp::RSPCompile_Vector_VSAW ( void ) {

	uint32_t Word;

	#ifndef RSPCompileVsaw
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VSAW); return;
	#endif
...
void Rsp::RSPCompile_Vector_VLT ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VLT);
}

void Rsp::RSPCompile_Vector_VEQ ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VEQ);
}

void Rsp::RSPCompile_Vector_VNE ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VNE);
}

int32_t Rsp::RSPCompile_Vector_VGE_MMX(void) {
...
void Rsp::RSPCompile_Vector_VGE ( void ) {
/*	int32_t bWriteToAccum = WriteToAccum(Low16BitAccum, RSPCompilePC);
...
/*	#if defined (DLIST)
	...
	#endif
*/
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VGE);
}

void Rsp::RSPCompile_Vector_VCL ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VCL);
}

void Rsp::RSPCompile_Vector_VCH ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VCH);
}

void Rsp::RSPCompile_Vector_VCR ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VCR);
}

void Rsp::RSPCompile_Vector_VMRG ( void ) {

	int32_t count, el, del;

	#ifndef RSPCompileVmrg
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMRG); return;
	#endif
...
int32_t Rsp::RSPCompile_Vector_VAND_MMX ( void ) {
...
void Rsp::RSPCompile_Vector_VAND ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VAND); return;
	#endif
...
void Rsp::RSPCompile_Vector_VNAND ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VNAND);
}

int32_t Rsp::RSPCompile_Vector_VOR_MMX ( void ) {
...
void Rsp::RSPCompile_Vector_VOR ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VOR); return;
	#endif
...
void Rsp::RSPCompile_Vector_VNOR ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VNOR);
}

int32_t Rsp::RSPCompile_Vector_VXOR_MMX ( void ) {
...
void Rsp::RSPCompile_Vector_VXOR ( void ) {
	...
	RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Vector_VXOR);
}

void Rsp::RSPCompile_Vector_VNXOR ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VNXOR);
}

void Rsp::RSPCompile_Vector_VRCP ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VRCP);
}

void Rsp::RSPCompile_Vector_VRCPL ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VRCPL);
}

void Rsp::RSPCompile_Vector_VRCPH ( void ) {

	int32_t count, el, last = -1;
	int32_t bWriteToAccum = WriteToAccum(Low16BitAccum, RSPCompilePC);

	#ifndef RSPCompileVrcph
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VRCPH); return;
	#endif
...
void Rsp::RSPCompile_Vector_VMOV ( void ) {

	int32_t el;

	#ifndef RSPCompileVmov
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VMOV); return;
	#endif
...
void Rsp::RSPCompile_Vector_VRSQ ( void ) {
	CPU_Message(RSPCompilePC,RSPOpcodeName(RSPOpC.Hex,RSPCompilePC));
	RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Vector_VRSQ);
}

void Rsp::RSPCompile_Vector_VRSQL ( void ) {
	CPU_Message(RSPCompilePC,RSPOpcodeName(RSPOpC.Hex,RSPCompilePC));
	RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Vector_VRSQL);
}

void Rsp::RSPCompile_Vector_VRSQH ( void ) {

	int32_t count, el;

	#ifndef RSPCompileVrsqh
	RSPCheat_r4300iOpcode(&Rsp::RSP_Vector_VRSQH); return;
	#endif
...
void Rsp::RSPCompile_Vector_VNOOP ( void ) {

}

/************************** lc2 functions **************************/

void Rsp::RSPCompile_Opcode_LBV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LBV);
}

void Rsp::RSPCompile_Opcode_LSV ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LSV); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 1) != 0) {
			...
			RSPMoveVariableToX86regByte(cpu.DMEM + ((Addr + 0) ^ 3), x86_ECX);

			RSPMoveVariableToX86regByte(cpu.DMEM + ((Addr + 1) ^ 3), x86_EDX);
			...
			RSPMoveVariableToX86regHalf(cpu.DMEM + (Addr ^ 2), x86_EDX);
...
void Rsp::RSPCompile_Opcode_LLV ( void ) {

	int32_t offset = (RSPOpC.voffset << 2);
	uint8_t * Jump[2];

	#ifndef RSPCompileLlv
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LLV); return;
	#endif
	...
	if ((RSPOpC.del & 0x3) != 0) {
 	...
 	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 3) != 0) {
			...
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_LLV);
			return;
		}
...
void Rsp::RSPCompile_Opcode_LDV ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LDV); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 3) != 0) {
			CompilerWarning( RSPCompilePC);
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_LDV);
			return;
		}


		RSPMoveVariableToX86reg(cpu.DMEM + Addr + 0, x86_EAX);

		RSPMoveVariableToX86reg(cpu.DMEM + Addr + 4, x86_ECX);
...
void Rsp::RSPCompile_Opcode_LQV ( void ) {

	int32_t offset = (RSPOpC.voffset << 4);
	uint8_t * Jump[2], * Jump3;

	#ifndef RSPCompileLqv
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LQV); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if (Addr & 15) {
			CompilerWarning( RSPCompilePC);
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_LQV);
			return;
		}
		...
		if (IsSseEnabled == 0) {
			...
			RSPMoveVariableToX86reg(cpu.DMEM + Addr + 4, x86_EBX);

			RSPMoveVariableToX86reg(cpu.DMEM + Addr + 8, x86_ECX);

			RSPMoveVariableToX86reg(cpu.DMEM + Addr + 12, x86_EDX);
			...
			RSPSseMoveUnalignedVariableToReg(cpu.DMEM + Addr, x86_XMM0);
...
//	RSPBreakPoint();
	...
	//if(RSPRecompPos == 0x0000004400000328)
		//Int3();
//	RSPx86_SetBranch32b(Jump[0], RSPRecompPos);
//void Rsp::RSPx86_SetBranch32b(void * JumpByte, void * Destination) {
//	*(uint32_t*)(JumpByte) = (uint32_t)((uint8_t*)Destination - (uint8_t*)((uint32_t*)JumpByte + 1));
//}
...
void Rsp::RSPCompile_Opcode_LRV ( void ) {
	int32_t offset = (RSPOpC.voffset << 4);
	uint8_t * Loop, * Jump[2];

	#ifndef RSPCompileLrv
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LRV); return;
	#endif
	...
	if (Compiler.bAlignVector == 0) {
		...
		RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_LRV);
		RSPJmpLabel32( 0);
		Jump[1] = RSPRecompPos - 4;
...
void Rsp::RSPCompile_Opcode_LPV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LPV);
}

void Rsp::RSPCompile_Opcode_LUV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LUV);
}


void Rsp::RSPCompile_Opcode_LHV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LHV);
}


void Rsp::RSPCompile_Opcode_LFV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LFV);
}

void Rsp::RSPCompile_Opcode_LTV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_LTV);
}

/************************** sc2 functions **************************/

void Rsp::RSPCompile_Opcode_SBV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SBV);
}

void Rsp::RSPCompile_Opcode_SSV ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SSV); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 1) != 0) {
			...
			RSPMoveX86regByteToVariable(x86_ECX, cpu.DMEM + ((Addr + 0) ^ 3));

			RSPMoveX86regByteToVariable(x86_EDX, cpu.DMEM + ((Addr + 1) ^ 3));
		} else {

			RSPMoveVariableToX86regHalf(&RSP_Vect[RSPOpC.rt].B[15 - (RSPOpC.del + 1)], x86_ECX);

			RSPMoveX86regHalfToVariable(x86_ECX, cpu.DMEM + (Addr ^ 2));
		}
		return;
	}
...
void Rsp::RSPCompile_Opcode_SLV ( void ) {

	int32_t offset = (RSPOpC.voffset << 2);
	uint8_t * Jump[2];

	#ifndef RSPCompileSlv
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SLV); return;
	#endif
...
//	}
 	...
 	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 3) != 0) {
			...
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_SLV);
			return;
		}
...
void Rsp::RSPCompile_Opcode_SDV ( void ) {
	...
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SDV); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if ((Addr & 3) != 0) {
			CompilerWarning( RSPCompilePC);
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_SDV);
			return;
		}
		...
		RSPMoveX86regToVariable(x86_EBX, cpu.DMEM + Addr + 4);
		return;
	}
...
void Rsp::RSPCompile_Opcode_SQV ( void ) {

	int32_t offset = (RSPOpC.voffset << 4);
	uint8_t * Jump[2];

	#ifndef RSPCompileSqv
 	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SQV); return;
	#endif
	...
	if (IsRegConst(RSPOpC.base) == 1) {
		...
		if (Addr & 15) {
			CompilerWarning( RSPCompilePC);
			RSPCheat_r4300iOpcodeNoMessage(&Rsp::RSP_Opcode_SQV);
			return;
		}
		...
		if (IsSseEnabled == 0) {
			...
			RSPMoveX86regToVariable(x86_EAX, cpu.DMEM + Addr + 0);

			RSPMoveX86regToVariable(x86_EBX, cpu.DMEM + Addr + 4);

			RSPMoveX86regToVariable(x86_ECX, cpu.DMEM + Addr + 8);

			RSPMoveX86regToVariable(x86_EDX, cpu.DMEM + Addr + 12);
		} else {

			RSPSseMoveAlignedVariableToReg(&RSP_Vect[RSPOpC.rt].B[0], x86_XMM0);
			RSPSseShuffleReg(x86_XMM0, x86_MM0, 0x1b);

			RSPSseMoveUnalignedRegToVariable(x86_XMM0, cpu.DMEM + Addr);
		}
		return;
	}
...
void Rsp::RSPCompile_Opcode_SRV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SRV);
}

void Rsp::RSPCompile_Opcode_SPV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SPV);
}

void Rsp::RSPCompile_Opcode_SUV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SUV);
}

void Rsp::RSPCompile_Opcode_SHV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SHV);
}

void Rsp::RSPCompile_Opcode_SFV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SFV);
}

void Rsp::RSPCompile_Opcode_STV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_STV);
}

void Rsp::RSPCompile_Opcode_SWV ( void ) {
	RSPCheat_r4300iOpcode(&Rsp::RSP_Opcode_SWV);
}

/************************** Other functions **************************/

void Rsp::RSPCompile_UnknownOpcode (void) {
	CPU_Message(RSPCompilePC, RSPOpcodeName(RSPOpC.Hex,RSPCompilePC) );
	RSPNextInstruction = FINISH_BLOCK;
	RSPMoveConstToVariable(RSPCompilePC,PrgCount);
	RSPMoveConstToVariable(RSPOpC.Hex,&RSPOpC.Hex);
	CALL_RSPFUNC(&Rsp::rsp_UnknownOpcode );
	RSPRet();
}
