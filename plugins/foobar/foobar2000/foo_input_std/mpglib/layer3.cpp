...
void mpglib::III_get_side_info_1(struct III_sideinfo *si,int stereo,int ms_stereo,long sfreq)
{
	int ch, gr;
 ...
 */
void mpglib::III_get_side_info_2(struct III_sideinfo *si,int stereo,int ms_stereo,long sfreq)
{
	int ch;
...
#if 1
			//as reported by xquake - http://www.hydrogenaudio.org/index.php?showtopic=22878&view=findpost&p=222772
			if (gr_infos->block_type != 2)
			{
				if(sfreq == 8)
					gr_infos->region1start = 54;
				else
