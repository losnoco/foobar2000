...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "./src/aosdk" /D ENABLE_UNICODE_PLUGIN=1 /D "NDEBUG" /D "IN_XSF_EXPORTS" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_CRT_SECURE_NO_DEPRECATE" /FD /c
# SUBTRACT CPP /YX
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /pdb:none /machine:I386 /out:"in_aoqsfu.dll"
# Begin Custom Build
TargetPath=.\in_aoqsfu.dll
TargetName=in_aoqsfu
InputPath=.\in_aoqsfu.dll
SOURCE="$(InputPath)"

"C:\Program Files\Winamp\Plugins\$(TargetName).dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy "$(TargetPath)" "C:\Program Files\Winamp\Plugins\$(TargetName).dll"
...
# ADD CPP /nologo /MTd /W3 /GX /ZI /Od /I "src/aosdk" /I "src/aosdk/zlib" /D ENABLE_UNICODE_PLUGIN=1 /D "LSB_FIRST" /D "_DEBUG" /D "IN_XSF_EXPORTS" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_CRT_SECURE_NO_DEPRECATE" /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /out:"C:\Program Files\Winamp\Plugins/in_aoqsfu.dll" /pdbtype:sept
# Begin Custom Build
TargetPath=\Program Files\Winamp\Plugins\in_aoqsfu.dll
TargetName=in_aoqsfu
InputPath=\Program Files\Winamp\Plugins\in_aoqsfu.dll
SOURCE="$(InputPath)"
