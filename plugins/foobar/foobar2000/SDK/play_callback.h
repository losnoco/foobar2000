...
public:
	...
	virtual void on_playback_new_track(const metadb_handle_ptr & track)=0;
	...
	virtual void on_playback_edited(const metadb_handle_ptr & track)=0;//currently played file got edited
	virtual void on_playback_dynamic_info(const file_info * info,bool b_track_change)=0;
	virtual void on_playback_time(const metadb_handle_ptr & track,double val) = 0;//called every second
