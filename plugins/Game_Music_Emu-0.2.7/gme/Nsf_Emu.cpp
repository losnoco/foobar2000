...
{
	if ( emu->vrc6 ) emu->write_vrc6( emu, addr, data );
	if ( emu->vrc7 ) emu->write_vrc7( emu, addr, data );
	if ( emu->namco ) emu->write_namco_addr( emu, addr, data );
	if ( emu->fme7 ) emu->write_fme7( emu, addr, data );
}
