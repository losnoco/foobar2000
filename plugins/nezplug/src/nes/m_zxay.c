...
static Uint32 read_event(ZXAY *THIS_, Uint32 a)
{
	return THIS_->ram[a];
}

static Uint32 busread_event(ZXAY *THIS_, Uint32 a)
{
	return 0x38;
}

static void write_event(ZXAY *THIS_, Uint32 a, Uint32 v)
{
	THIS_->ram[a] = v;
}

static Uint32 ioread_event(ZXAY *THIS_, Uint32 a)
{
	return 0xff;
}
...
static void iowrite_event(ZXAY *THIS_, Uint32 a, Uint32 v)
{
