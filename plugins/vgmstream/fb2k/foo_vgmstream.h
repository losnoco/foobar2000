...
class input_vgmstream {
	...
	private:
		...
		void getfileinfo(char *filename, char *title, int *length_in_ms, int *actual_length, int *loop_start, int *loop_end, int *sample_rate, int *channels, abort_callback & p_abort);
		void load_settings();
