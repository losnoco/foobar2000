...
class SID_EXTERN SidTune
{
 ...
 public:  // ----------------------------------------------------------------
	...
	// Load a dual-file sidtune from a memory buffer.
	// Currently supproted: MUS/STR format
	SidTune(const uint_least8_t* data, const uint_least32_t dataLen, const uint_least8_t* data2, const uint_least32_t data2Len);
	...
	// From two buffers.
	bool read(const uint_least8_t* data, uint_least32_t dataLen, const uint_least8_t* data2, uint_least32_t data2Len);
