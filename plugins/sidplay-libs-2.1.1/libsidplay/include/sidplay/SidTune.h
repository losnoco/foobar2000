...
class SID_EXTERN SidTune
{
 ...
 public:  // ----------------------------------------------------------------
	...
	// Load a dual-file sidtune from a pair of memory buffers.
	// Currently supported: SidPlayer MUS/STR pair
	SidTune(const uint_least8_t* firstPartSidtune, const uint_least32_t firstLength, const uint_least8_t* secondPartSidtune, const uint_least32_t secondLength);
	...
	// From two buffers
	bool read(const uint_least8_t* sourceBuffer, const uint_least32_t bufferLen, const uint_least8_t* source2Buffer, const uint_least32_t buffer2Len);
 ...
 private:  // ---------------------------------------------------------------
	...
	// Try to retrieve dual-file sidtune from specified buffers.
	void getFromBuffer(const uint_least8_t* const buffer, const uint_least32_t bufferLen, const uint_least8_t* const buffer2, const uint_least32_t buffer2Len);
