...
enum {
  ...
  FLUID_SAMPLE_LOAD                     /**< Sample needs to load */
};
...
struct _fluid_sfloader_t {
   ...
   */
  fluid_sfont_t* (*load)(fluid_sfloader_t* loader, const FLUID_TCHAR* filename);
};
...
struct _fluid_sfont_t {
   ...
   */
  int (*free)(fluid_sfont_t* sfont, int force);
   ...
   */
  FLUID_TCHAR* (*get_name)(fluid_sfont_t* sfont);
