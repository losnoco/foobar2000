...
/* functions */
SFData *sfload_file (const FLUID_TCHAR * fname);
...
{
  FLUID_TCHAR* filename;           /* the filename of this soundfont */
  FILE* file_handle;        /* the handle to the file, for sample loading */
