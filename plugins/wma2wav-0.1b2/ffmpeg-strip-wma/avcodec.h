...
int avcodec_decode_audio(AVCodecContext *avctx, float *samples, 
                         int *frame_size_ptr,
                         uint8_t *buf, int buf_size);
...
#define av_log_get_level(a) 0
#define av_log_set_level(a)
#define av_log_set_callback(a)
