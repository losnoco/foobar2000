...
namespace dami
{
  namespace io
  {
    ...
    ID3_C_EXPORT String      readUnicodeString(ID3_Reader&, bool = false);
    ID3_C_EXPORT String      readUnicodeText(ID3_Reader&, size_t, bool = false);
    ...
    ID3_C_EXPORT size_t      writeUnicodeString(ID3_Writer&, String, bool = true, bool = false);
    ID3_C_EXPORT size_t      writeUnicodeText(ID3_Writer&, String, bool = true, bool = false);
